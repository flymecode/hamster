package com.xupt.hamster.core.utils;
...
public class TokenUtils {
    ...
    public String generateToken(TokenDetail tokenDetail, Long timeOutMillis) {
        ...
        Long expiration = Long.parseLong(claims.get(Constants.TOKEN_CREATE_TIME) + "") + timeOutMillis;
    ...
    private String generate(Map<String, Object> claims) {
        Long expiration = Long.parseLong(claims.get(Constants.TOKEN_CREATE_TIME) + "") + TIMEOUT;
        try {
            return Jwts.builder()
                    .setClaims(claims)
                    .setSubject(claims.get(Constants.TOKEN_USER_NAME).toString())
